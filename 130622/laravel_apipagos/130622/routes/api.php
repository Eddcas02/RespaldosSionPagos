...
Route::middleware('auth:api')->group(function (){
    ...
    //OcultarColumnaUsuarioController
    ...
    Route::get('pendientesreporte', [ReportesController::class, 'pendientesreporte']);
    
    //Reporte Cancelado de Origen
    Route::get('canceladosreporte', [ReportesController::class, 'canceladosreporte']);
    
    //Reporte Pendientes Validación
    Route::get('pendientesvalidacionreporte', [ReportesController::class, 'pendientesvalidacionreporte']);
    
    //Reporte Rechazado por banco
    Route::get('rechazadosreporte', [ReportesController::class, 'rechazadosreporte']);
    
    //Reporte Compensados
    Route::get('compensadosreporte', [ReportesController::class, 'compensadosreporte']);
    
    //Reporte no visados
    Route::get('novisadoreporte', [ReportesController::class, 'novisadoreporte']);
